<?php require_once __DIR__ . '/app/bootstrap.php'; admin_only();
      ...
      <div class="bg-white rounded-2xl shadow p-6">
        ...
        <div class="space-y-3" style="max-height:24rem;overflow:auto;">
          ...
          <?php foreach ($reports_open as $r): ?>
            <div class="p-3 bg-gray-50 rounded flex items-center justify-between">
              <div>
                <div class="font-semibold">#<?= (int)$r['id'] ?> — <?= e($r['target_type']) ?> <?= (int)$r['target_id'] ?></div>
  ...
  <?php elseif ($tab==='settings'): ?>
    <div class="bg-white rounded-2xl shadow-xl p-8">
      ...
      <form method="post" class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-3"><button name="save_settings" value="1" class="bg-green-600 text-white px-8 py-3 rounded-lg"><i class="fas fa-save mr-2"></i>Save Settings</button></div>
      </form>
    </div>
